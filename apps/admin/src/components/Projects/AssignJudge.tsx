...
interface AssignJudgeProps {
  onChange: (x: UserType | undefined) => void;
  value?: UserType;
  size?: keyof typeof sizes;
}

export const AssignJudge: React.FC<AssignJudgeProps> = ({
  value,
  onChange,
  size = "md",
}) => {
  ...
  const { run, loading } = useApi<UserType>("GET", "/admin/judge-details");
  ...
  return (
    <div className="r">
      ...
      <p className="mb-1">Judge email</p>
      <div
